...
//  TouchDemo
//
//  Created by smart on 2021/4/9.
//

import UIKit

class WWDCViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func addDots(_ count: Int, toView view: UIView) {
        for _ in 1...count {
            ...
            let longPress = UILongPressGestureRecognizer(target: self, action: #selector(WWDCViewController.handleLongPress(_:)))
